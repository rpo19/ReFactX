#!/bin/bash
#SBATCH --output=logs/eval_cwq_grpo_checkpoint720_%j.out
#SBATCH --error=logs/eval_cwq_grpo_checkpoint720_%j.err
#SBATCH --job-name=eval_cwq_grpo720
#SBATCH -N 1
...
python -m utils.eval --config configs/config_cwq_qwen35_4b_grpo_checkpoint720_test.json

teleclinotify "CWQ GRPO checkpoint-720 eval done | SLURM_JOB_ID=$SLURM_JOB_ID"
