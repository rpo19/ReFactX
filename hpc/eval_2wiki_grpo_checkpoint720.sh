#!/bin/bash
#SBATCH --output=logs/eval_2wiki_grpo_checkpoint720_%j.out
#SBATCH --error=logs/eval_2wiki_grpo_checkpoint720_%j.err
#SBATCH --job-name=eval_2wiki_grpo720
#SBATCH -N 1
...
python -m utils.eval --config configs/config_2wiki_qwen35_4b_grpo_checkpoint720_valid.json

teleclinotify "2WikiMultihop GRPO checkpoint-720 eval done | SLURM_JOB_ID=$SLURM_JOB_ID"
