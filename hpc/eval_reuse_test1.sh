#!/bin/bash
#SBATCH --output=logs/eval_reuse1_%j.out
#SBATCH --job-name=refactx_20
#SBATCH -N 1
#SBATCH --error=logs/eval_reuse1_%j.err
#SBATCH --time=30:00
#SBATCH --mem=100G
...
cat > /tmp/config_mintaka_35b3_test_n20.json << 'CFG'
{
    "experiment_name": "mintaka_test_qwen36_35b_n20",
    "output": null,
    "log_dir": "logs",
    "tablename": "qwen36",
...
python -m utils.eval --config /tmp/config_mintaka_35b3_test_n20.json
echo "DONE at $(date)"
