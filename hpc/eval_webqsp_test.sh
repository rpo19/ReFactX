#!/bin/bash
#SBATCH --output=logs/eval_webqsp_test_%j.out
#SBATCH --job-name=refactx_webqsp_test
#SBATCH -N 1
#SBATCH --error=logs/eval_webqsp_test_%j.err
...
teleclinotify "refactx_webqsp_test done | SLURM_JOB_ID=$SLURM_JOB_ID"
