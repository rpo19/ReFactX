#!/bin/bash
#SBATCH --output=logs/test_2wiki_qwen38_27b_%j.out
#SBATCH --job-name=refactx_2wiki_qwen38
#SBATCH -N 1
#SBATCH --error=logs/test_2wiki_qwen38_27b_%j.err
...
teleclinotify "test_2wiki_qwen38_27b done | SLURM_JOB_ID=$SLURM_JOB_ID"
