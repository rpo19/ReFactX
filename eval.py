...
def main(experiment_name, output_file, index_config_path, model_config_path, dataset_config_path, prompt_config_path, wandb, unconstrained_generation, debug, continue_from_previous_run, log_dir):
