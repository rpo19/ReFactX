...
def get_constrained_logits_processor(tokenizer, index, num_beams=1, num_batches=1, return_list=True, avoid_duplicates=True, **kwargs):
    from refactx.generate import get_constrained_logits_processor as _base
    return _base(tokenizer, index, num_beams=num_beams, num_batches=num_batches, return_list=return_list, avoid_duplicates=avoid_duplicates, **kwargs)
